...
Resilience-
Resilience4j has different modules. Following are 2 imp  out f them:-
CircuitBreaker
Retry

The sequence of how these modules are applied to these functions is predifined which res4j call it aspect order
If we want to customise that, we have to change it.
Circuit breaker has greater aspect order than Retry by default

FYI,
Configuration of these resilience properties can also be done through java code
Though that gives you flexibility and power, it is lengthy, complex and error prone tasks
